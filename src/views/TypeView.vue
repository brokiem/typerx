  ...
  <div class="flex flex-col justify-center items-center mx-5">
    <div class="max-w-5xl w-full mt-10">
      <div class="flex select-none items-center">
        ...
        <svg v-if="stars_count !== null" xmlns="http://www.w3.org/2000/svg" height="20" width="20" fill="currentColor" class="inline mr-2"><path d="m5.062 18 1.313-5.542L2 8.729l5.75-.5L10 3l2.25 5.25 5.75.479-4.375 3.729L14.938 18 10 15.062Z"/></svg>
        <a href="https://github.com/brokiem/typerx" target="_blank">
...
export default defineComponent({
  ...
  mounted() {
    this.getStarsCount("brokiem", "typerx").then((stars_count) => {
      // @ts-ignore
  ...
  methods: {
    ...
    getStarsCount(owner: string, repo: string) {
